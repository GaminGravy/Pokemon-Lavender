...
//names
const u8 gText_SideQuestName_1[] = _("Fragments of Genesis");
const u8 gText_SideQuestName_2[] = _("Side Quest 2");
const u8 gText_SideQuestName_3[] = _("Side Quest 3");
const u8 gText_SideQuestName_4[] = _("The Lost Bulbasaur");
const u8 gText_SideQuestName_5[] = _("Echoes of Evolution");
const u8 gText_SideQuestName_6[] = _("Bound By Trade");
const u8 gText_SideQuestName_7[] = _("Whispers of The White Fox");
const u8 gText_SideQuestName_8[] = _("Glimmer Beneath the Surface");
const u8 gText_SideQuestName_9[] = _("When Shadows Smile");
const u8 gText_SideQuestName_10[] = _("Cat's Out of the Bag");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Ancient myths are awakening reveal the truth.");
const u8 gText_SideQuestDesc_2[] = _("Description 2");
const u8 gText_SideQuestDesc_3[] = _("Description 3");
const u8 gText_SideQuestDesc_4[] = _("Find the lady's lost Bulbasaur in Petalburg Woods");
const u8 gText_SideQuestDesc_5[] = _("Prove your strength in the Cave of Awakening");
const u8 gText_SideQuestDesc_6[] = _("Find Proffesor Link a Machop, Abra, and Geodude");
const u8 gText_SideQuestDesc_7[] = _("Description 7");
const u8 gText_SideQuestDesc_8[] = _("Chain fish for a shiny Pokemon!");
const u8 gText_SideQuestDesc_9[] = _("Description 9");
const u8 gText_SideQuestDesc_10[] = _("Find the woman's Golden Locket.");
...
const u8 gText_SideQuestDoneDesc_4[] = _("Completed The Lost Bulbasaur");
...
const u8 gText_SideQuestMap4[] = _("Petalburg");
const u8 gText_SideQuestMap5[] = _("Map 5");
const u8 gText_SideQuestMap6[] = _("Route 114");
