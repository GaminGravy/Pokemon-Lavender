...
// const rom data
static const u16 sUnusedUnknownPal[] = INCBIN_U16("graphics/title_screen/LavenderTitleScreen.gbapal");

static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/LavenderTiles.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/LavenderTiles.bin.lz");
