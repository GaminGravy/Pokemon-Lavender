...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_DEXNAVSEARCH_0x024 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_DEXNAVGET_0x025 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_DEXNAVDETECTOR_0x026 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_DEXNAVSPECIES_0x40F7 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_DEXNAVSTEPCOUNTER_0x40F8 // Steps for finding hidden pokemon
